 ...
 *
 */
public final class MidSingularityQuickSort extends Sort {

    public MidSingularityQuickSort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("Mid Singularity Quick");
        this.setRunAllSortsName("Mid Singularity Quick Sort");
        this.setRunSortName("Mid Singularity Quicksort");
    ...
    void innerSort(int[] array, int a, int b, int depth, int rep) {
        while (b - a > insertlimit) {
            ...
            if (rIdx >= b)
                return;
            int[] pr = partition(array, a, b, array[a + (rIdx - 1 - a) / 2]);
            ...
            depth++;
            if (rLen < lLen) {
                innerSort(array, pr[1], b, depth, rep);
                b = pr[0];
            } else {
                innerSort(array, a, pr[0], depth, rep);
                a = pr[1];
            }
        }
