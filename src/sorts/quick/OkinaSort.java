...
Original name of this algorithm: Pattern-Improved Aeos Priority Quicksort
...
public final class OkinaSort extends Sort {
    ...
    public OkinaSort(ArrayVisualizer arrayVisualizer) {
        ...
        this.setSortListName("Okina");
        this.setRunAllSortsName("Okina Sort");
        this.setRunSortName("Okinasort");
    ...
    protected int[] partition(int[] array, int[] buf, int[] tags, int a, int b, int bLen, int piv, boolean bias,
        ...
        boolean badStreak = maxStreaks > bCnt / 4 + 1;
    ...
    public void quickSort(int[] array, int a, int b) {
        ...
        int sixth = len / 6;
        sortHelper(array, buf, tags, a, b, bLen, streaks > len / 20 || balance <= sixth || balance + eq >= len - sixth);
